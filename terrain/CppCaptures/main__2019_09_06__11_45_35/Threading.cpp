...
//--------------------------------------------------------------------------------------
bool CreateReplayerThreads(ThreadRunner** threadRunners, unsigned int numThreads, HANDLE* threadSequenceEvents, HANDLE* threadDoneEvents, bool& exitReplayerThreads, bool& releaseReplayerThreads)
{
    for (unsigned int currentThread = 0; currentThread < numThreads; ++currentThread)
    {
        ThreadStartParams* params = new ThreadStartParams();
        {
            ...
            params->releaseReplayerThreads = &releaseReplayerThreads;
        }
...
//--------------------------------------------------------------------------------------
void ReleaseReplayerThreads(unsigned int numThreads, HANDLE* threadSequenceEvents, HANDLE* threadDoneEvents, bool& releaseReplayerThreads)
{
