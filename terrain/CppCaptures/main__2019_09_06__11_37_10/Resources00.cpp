...
void CreateResources00()
{
    ...
    // Create Context_uid_4 and its staging resource
    {
        ...
        Context_uid_4 = glXCreateContextAttribsARB(display_0x559eaa677cd0, glxFBConfig_0x559eaa6e1b60, NULL, true, int_temp_1);

        // Create Context_uid_4_Staging
        {
            BEGIN_DATA_SCOPE();

            Context_uid_4_Staging = glXCreateContextAttribsARB(display_0x559eaa677cd0, glxFBConfig_0x559eaa6e1b60, Context_uid_4, true, int_temp_1);
            NV_EXEC_GL(glFinish());
...
void CreateWinResources00()
{
    ...
    display_0x559eaa677cd0 = (*reinterpret_cast<Display**>(WindowSystemInstance().GetDisplayAddr()));
    glxFBConfig_0 = 0;
    int int_temp_2 = 0;
    static GLXFBConfig* pGLXFBConfig_temp_1 = NULL;
    pGLXFBConfig_temp_1 = glXGetFBConfigs(display_0x559eaa677cd0, DefaultScreen(display_0x559eaa677cd0), &int_temp_2);
    ...
    glxFBConfig_0x559eaa6e1b60 = pGLXFBConfig_temp_1[0];
    ...
    GLXFBConfig GLXFBConfig_temp_1 = GLXChooseConfig(display_0x559eaa677cd0, int_temp_3, pGLXFBConfig_temp_1, int_temp_2);
    glxFBConfig_0x559eaa6e1b60 = (GLXFBConfig_temp_1 ? GLXFBConfig_temp_1 : glxFBConfig_0x559eaa6e1b60);
    {
        BEGIN_DATA_SCOPE();

        auto windowData = std::make_tuple(&glxFBConfig_0x559eaa6e1b60, nullptr, 0);
        WindowSystemInstance().CreateNativeWindow(&windowData, 1280, 1023);
        glxDrawable_440000b = (*reinterpret_cast<GLXDrawable*>(WindowSystemInstance().GetWindowAddr()));
    }
}
...
void ReleaseResources00()
{
    ...
    glXDestroyContext(display_0x559eaa677cd0, Context_uid_4);
    glXDestroyContext(display_0x559eaa677cd0, Context_uid_4_Staging);
}
...
void ReleaseWinResources00()
{
    ...
    WindowSystemInstance().DestroyWindow(&glxDrawable_440000b);
...
GLXDrawable glxDrawable_440000b;
Display* display_0x559eaa677cd0 = NULL;
GLXFBConfig glxFBConfig_0x559eaa6e1b60;
