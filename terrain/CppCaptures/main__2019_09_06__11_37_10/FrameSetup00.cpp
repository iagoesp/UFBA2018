...
void SetInitialFrameState00()
{
    ...
    // Buffer_uidof_17
    {
        ...
        NV_EXEC_GL(glBufferData(GL_COPY_WRITE_BUFFER, 12288, NV_GET_RESOURCE(GLvoid*, 0), GL_STATIC_DRAW));
    }
    ...
    // Buffer_uidof_16
    {
        ...
        NV_EXEC_GL(glBufferData(GL_COPY_WRITE_BUFFER, 13068, NV_GET_RESOURCE(GLvoid*, 1), GL_STATIC_DRAW));
    }
