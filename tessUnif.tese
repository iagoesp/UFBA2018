...
void main(){
    vec3 newTcPosition0 = (tcPosition[0]); newTcPosition0.y = iqfBm(newTcPosition0, 10, 32, 1.2);
    vec3 newTcPosition1 = (tcPosition[1]); newTcPosition1.y = iqfBm(newTcPosition1, 10, 32, 1.2);
    vec3 newTcPosition2 = (tcPosition[2]); newTcPosition2.y = iqfBm(newTcPosition2, 10, 32, 1.2);
